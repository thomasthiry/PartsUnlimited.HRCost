...
public class EmployeeCostIntegrationTests : IClassFixture<DatabaseFixture>
{
    private IntegrationAppBuilder App;

    public EmployeeCostIntegrationTests(DatabaseFixture databaseFixture)
    {
        App = new(new(databaseFixture.ConnectionString));
    }
    ...
    public void The_yearly_gross_salary_cost_of_an_employee_is_12_times_the_monthly_gross_salary()
    {
        ...
        var app = App.With(employee).Build();
